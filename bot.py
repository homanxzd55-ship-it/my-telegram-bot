...
# --- تنظیمات کلیدی (امنیت بالا - خواندن از فایل .env یا رندر) ---
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN")
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")
OPENROUTER_FAST_KEY = os.getenv("OPENROUTER_FAST_KEY")
OPENROUTER_HEAVY_KEY = os.getenv("OPENROUTER_HEAVY_KEY")

# آیدی عددی تلگرام خودت و رفیقت (این را می‌توانی مستقیم بنویسی، خطر امنیتی ندارد)
...
def call_gemini(prompt):
    # جایگزین کردن با آدرس ورکر کلاودفلر خودت
...
def handle_message(message):
    ...
    # تشخیص هوشمند برای سوالات سنگین (دقت بالا)
    ...
    try:
        ...
        try:
            ...
            bot.reply_to(message, "⚠️ سیستم در حال حاضر شلوغ است. دوباره تلاش کن.")
