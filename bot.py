...
# --- ربات اطلاعات حساس را مستقیم از پنل امن رندر می‌خوند (امنیت ۱۰۰٪) ---
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN")
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")
OPENROUTER_FAST_KEY = os.getenv("OPENROUTER_FAST_KEY")
OPENROUTER_HEAVY_KEY = os.getenv("OPENROUTER_HEAVY_KEY")

# آیدی عددی تلگرام خودت و دوستت (آیدی‌های واقعی خودتان را جای این دو عدد فرضی بگذار)
...
def call_gemini(prompt):
    # به جای YOUR_WORKER_URL آدرس ورکر کلاودفلر خودت را بگذار (آدرس ورکر کلید مخفی نیست)
